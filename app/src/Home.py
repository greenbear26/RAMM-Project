...
">
    <img src="data:image/png;base64,{_logo_b64}"
         style="height: 100px; object-fit: contain; margin-bottom: 16px;" />
    <h1 style="color: #FFFFFF; font-size: 52px; font-weight: 800; margin: 0 0 12px 0;
               letter-spacing: -1px;">LobbyLens</h1>
    <p style="color: #93C5FD; font-size: 20px; margin: 0 0 16px 0; font-weight: 500;">
        Transparency into EU Lobbying &amp; Political Influence
    </p>
    <p style="color: #CBD5E1; font-size: 15px; max-width: 620px; margin: 0 auto; line-height: 1.7;">
